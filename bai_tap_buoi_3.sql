...
(7, 2, '2024-09-01 10:00:00'),
(3, 3, '2024-09-01 10:30:00'),
(1, 2, '2024-09-02 11:00:00'),
(2, 1, '2024-09-02 11:30:00'),
(3, 1, '2024-09-02 12:00:00'),
(9, 3, '2024-09-03 12:30:00'),
(2, 3, '2024-09-03 13:00:00'),
(3, 2, '2024-09-03 13:30:00'),
(1, 4, '2024-09-04 14:00:00'),
(2, 5, '2024-09-04 14:30:00'),
(4, 6, '2024-09-04 15:00:00'),
(1, 6, '2024-09-05 15:30:00'),
(2, 5, '2024-09-05 16:00:00'),
(3, 4, '2024-09-05 16:30:00'),
(6, 7, '2024-09-06 17:00:00'),
(2, 8, '2024-09-06 17:30:00'),
(3, 9, '2024-09-06 18:00:00'),
(1, 8, '2024-09-07 18:30:00'),
(4, 7, '2024-09-07 19:00:00');
(5, 6, '2024-09-08 15:30:00'),
(5, 5, '2024-09-08 16:00:00'),
(5, 4, '2024-09-08 16:30:00'),
(6, 7, '2024-09-09 17:00:00'),
(6, 8, '2024-09-09 17:30:00'),
(6, 9, '2024-09-09 18:00:00'),
(6, 8, '2024-09-10 18:30:00'),
(7, 7, '2024-09-10 19:00:00');

-- query
-- Tìm 5 người đã like nhà hàng nhiều nhất.
SELECT user_id, COUNT(user_id) AS num_likes
FROM like_res
GROUP BY user_id
...
SELECT res_id, COUNT(res_id) AS num_likes
FROM like_res
GROUP BY res_id
ORDER BY num_likes DESC
LIMIT 2
...
WHERE o.user_id IS NULL AND r.user_id IS NULL AND l.user_id IS NULL;